...
def DB():
    try:
        csv_data = """
            ...
            40085,2024-05-10 12:24:06.000,PEDRO LUCAS DE SOUZA,pedro.souza@korasaude.com.br,THARCISIO GE DE OLIVEIRA,5585986460402,129,PRONTO SOCORRO GERAL,Meridional Cariacica,PA_ADULTO,bbce4d04-8964-4079-b7b0-794d55f6e310
